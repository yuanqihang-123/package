...
public class HashMapTest {
	public static void main(String[] args) {
		...
		HashMap<String, String> hashMap = new HashMap<String, String>();// 此Map用于存储随机字符串并测试读取速度
		...
		// 打印hashMap和smallList的长度，看看数据存储是否成功
